...
import { faEye, faEdit, faChevronUp, faChevronDown } from '@fortawesome/free-solid-svg-icons';
...
const AppUserListFaculty = () => {
  ...
  const [stats, setStats] = useState({ totalFaculty: 0 });
...
useEffect(() => {
  const fetchStats = async () => {
    try {
      ...
      setErrorMessage('Error fetching stats. Please try again later.');
            ...
            <div className="row g-4 mb-4">
                    ...
                    <div className="card-body">
                      <div className="d-flex align-items-start justify-content-between">
                       ...
                       <div className="content-left">
                          <span style={{ fontWeight: 'bold' }}>Faculty Members</span>
                          <div className="d-flex align-items-end mt-2">
                          <h4 className="mb-0 me-2">{stats.totalFaculty ? stats.totalFaculty.toLocaleString() : 'Loading...'}</h4>
                ...
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-start justify-content-between">
                      <div className="content-left">
                      <span style={{ fontWeight: 'bold' }}>Pending Consultations</span>
                        <div className="d-flex align-items-end mt-2">
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-start justify-content-between">
                      <div className="content-left">
                        <span style={{ fontWeight: 'bold' }}>Active Session</span>
                        <div className="d-flex align-items-end mt-2">
                        ...
                        <small>Total Active Session</small>
                      </div>
              ...
              <div className="col-sm-6 col-xl-3">
                <div className="card">
                  <div className="card-body">
                    <div className="d-flex align-items-start justify-content-between">
                      <div className="content-left">
                      <span style={{ fontWeight: 'bold' }}>Slots Availability</span>
                        <div className="d-flex align-items-end mt-2">
                        ...
                        <small>Number of Consultation Slots </small>
                      </div>
...
{/* Add Student Button */}
<button 
type="submit" className="btn btn-primary mb-3" onClick={handleOpenAddModal} > Add Faculty <i className="bi bi-plus-circle ms-2"></i>
</button>
{showAddModal && (
    ...
    <th className="bg-light" style={{ width: '130px' }} onClick={() => handleSort('section')}>
      <div className="sort-label">
        ...
        <span className="sort-arrows">
          <FontAwesomeIcon 
            icon={faChevronUp} 
            className={`arrow asc ${sortConfig.key === 'section' && sortConfig.direction === 'asc' ? 'active' : ''}`}
          />
          <FontAwesomeIcon 
            icon={faChevronDown} 
            className={`arrow desc ${sortConfig.key === 'section' && sortConfig.direction === 'desc' ? 'active' : ''}`}
          />
        </span>
      </div>
    </th>
...
<button 
  ...
  onClick={() => handleView(faculty.school_id)} 
  title="View Student">
        ...
        <div className="modal show" style={{ display: "block" }} onClick={handleCloseViewModal}>
          <div className="modal-dialog" onClick={(e) => e.stopPropagation()}>
            <div className="modal-content">
              ...
              <div className="modal-body">
                <p><strong>ID:</strong> {selectedFaculty.school_id}</p>
                <p><strong>Name:</strong> {selectedFaculty.name}</p>
                <p><strong>Email:</strong> {selectedFaculty.email}</p>
                <p><strong>Program:</strong> {selectedFaculty.program}</p>
                <p><strong>Year Level:</strong> {selectedFaculty.year_level}</p>
                <p><strong>Section:</strong> {selectedFaculty.section}</p>     
                <p><strong>Academic Year:</strong> {selectedFacultyt.academic_year}</p>
                <p><strong>Contact Number:</strong> {selectedFaculty.contact_number}</p>
                <p><strong>Subjects:</strong> {selectedFaculty.topics_or_subjects.join(', ')}</p>
...
export default AppUserListFaculty